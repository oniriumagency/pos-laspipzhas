...
const COLORS = {
  Propio: '#f6b713', // orange-500
  Rappi: '#ff4940',  // pink-500
  DiDi: '#fd7c41',   // yellow-500
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-bold transition-all duration-200 border shadow-sm ${rangoFecha === f.val
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-sm font-extrabold tracking-wide transition-all duration-200 border shadow-sm ${activo
                      ? `bg-slate-800 text-white border-slate-800`
